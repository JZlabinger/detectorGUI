...
class detector:
    ...
    self.DCU_IP = ip
    self.DCU_PORT = port
    self.detector = DEigerClient(DCU_IP, DCU_PORT)
...
def configFileWriter(pattern, mode='enabled', imagesPerFile=1000):
